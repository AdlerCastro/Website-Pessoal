...
const typographVariants = cva('text-white', {
  variants: {
    variant: {
      ...
      paragraph:
        'max-w-paragraph rounded-xl border border-solid border-paragraph bg-default p-4 text-start transition-all duration-300 font-Poppins text-base/[150%] h-fit',
    },
  },
});
