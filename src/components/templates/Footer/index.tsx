      ...
      <div className='Contatos'>
        <div className='Subscribe'>
          ...
          <Link
            ...
            target='_blank'
          >
            <Image className='iconGithub' src={GithubIcon} alt='Github' />
          </Link>
        </div>
        ...
        <div className='SocialMedia'>
          <SocialMediaButton
            ...
            href='https://www.instagram.com/adler_castro/'
            target='_blank'
          >
            <Image className='icons' src={InstagramIcon} alt='Instagram' />
          </SocialMediaButton>

          <SocialMediaButton
            className='SocialMediaButtons'
            href='https://www.linkedin.com/in/adler-augustus-de-castro-mota/'
            target='_blank'
          >
            <Image className='icons' src={LinkedInIcon} alt='LinkedIn' />
          </SocialMediaButton>

          <Link href='/Forms' className='SocialMediaButtons'>
            <Image className='icons' src={EmailIcon} alt='Email' />
          </Link>
        </div>
      </div>
